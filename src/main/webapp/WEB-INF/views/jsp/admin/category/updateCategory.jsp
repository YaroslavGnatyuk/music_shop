        ...
        <div div class="col-lg-8" style="margin-top:10px">
            <form:form method="post" cssStyle="margin-left: 150px" >
                <table>
                    <tr>
                        <td>Name:</td>
                        <td><form:input class="form-control" id = "focusedInput" value="${category.name}" type = "text" path="name" cssStyle="width: 500px;margin-top: 3px"/></td>
                    </tr>
                    <td colspan="2">
...
<div class="raw">
    <div div class="col-lg-12" style = "margin-top: 30%">

            ...
            <div class="panel panel-default panel-table">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <p ><h4 align="center"> Users </h4></p>
                        </div>

                        <div class="col-lg-3">
                             <span class="span12">
                                <form id="custom-search-form" method="post" class="form-search form-horizontal pull-right" action="/admin/find-user-by-id">
                    ...
                    <div class="col col-xs-8">
                        <ul class="pagination hidden-xs pull-right">
                            <c:if test="${page.currentPage!=1}">
                                <li><a href="/admin/user-page-${page.currentPage-1}" > << </a></li>
                            </c:if>
                            <c:forEach items="${page.valueButtonsInPagination}" var="p" >
                                <c:if test="${ !(p.equalsIgnoreCase('..')) && p.equalsIgnoreCase(page.currentPage.toString())}">
                                    <li class="active"><a href="/admin/user-page-${p}" ><c:out value="${p}"/></a></li>
                                </c:if>

                                <c:if test="${ !(p.equalsIgnoreCase('..')) && !(p.equalsIgnoreCase(page.currentPage.toString()))}">
                                    <li><a href="/admin/user-page-${p}" ><c:out value="${p}"/></a></li>
                                </c:if>

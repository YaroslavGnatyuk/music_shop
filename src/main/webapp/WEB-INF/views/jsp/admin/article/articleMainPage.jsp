        ...
        <div class="col-lg-10" style="margin-top:10px">
            <div class="panel panel-default panel-table">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-lg-1">
                            <a href="/admin/add-article" type="button" class="btn btn-sm btn-primary btn-create">Create New</a>
                        </div>
                        <div class="col-lg-1">
                            <a href="/admin/article-main-page" type="button" class="btn btn-sm btn-primary btn-success" style="margin-left: 5px"><span class="glyphicon glyphicon-arrow-up"></span></a>
                        </div>
                    ...
                    <c:forEach items="${page.articles}" var="article">
                        <tr>
                            ...
                            <td align="center"  style="width: 150px">
                                <a href="/admin/update-article/${article.id}" class="btn btn-default" alt="update article">
                                    <span class="glyphicon glyphicon-pencil" alt="delete article"></span>
                                </a>
                                <a href="/admin/delete-article/${article.id}" class="btn btn-danger">

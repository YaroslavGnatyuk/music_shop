        ...
        <div div class="col-lg-10" align="center" style="margin-top:10px">
            <form:form method="post" cssStyle="margin-left: 150px">
                <table>
                    ...
                    <tr>
                        <td>Author:</td>
                        <td><form:input class = "form-control" id = "focusedInput" type = "text" path="author" value = "${article.author}" cssStyle="width: 500px; margin-top: 3px"/></td>
                    </tr>

                    <tr>
                        <td>Name:</td>
                        <td><form:input class = "form-control" id = "focusedInput" type = "text" path="name" value = "${article.name}" cssStyle="width: 500px; margin-top: 3px"/></td>
                    </tr>
                    ...
                    <tr>
                        <td>Main text:</td>
                        <td><form:textarea class="form-control" rows="5" id="comment" path="article" value = "${article.article}" cssStyle="margin-top: 3px"></form:textarea></td>
                    </tr>

                    <tr>
                        <td colspan="2">
                            <input type="submit" class="btn btn-info btn-block"
                                   value="Update" style="margin-top: 15px;
